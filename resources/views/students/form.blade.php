            ...
            <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" class="overflow-hidden border border-[#d1d5db] bg-white shadow-[0_14px_40px_rgba(38,55,70,0.08)]">
                ...
                <section class="border-b border-[#d1d5db] p-6 md:p-8">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        ...
                        <div><label for="first_name" class="mb-2 block text-sm font-semibold">First name</label><input id="first_name" type="text" name="first_name" value="{{ old('first_name') }}" placeholder="First name" pattern="[A-Za-z ]+" title="Use letters and spaces only" class="field w-full rounded-md px-4 py-3" required></div>
                        <div><label for="middle_name" class="mb-2 block text-sm font-semibold">Middle name <span class="font-normal text-slate-400">(optional)</span></label><input id="middle_name" type="text" name="middle_name" value="{{ old('middle_name') }}" placeholder="Middle name" pattern="[A-Za-z ]+" title="Use letters and spaces only" class="field w-full rounded-md px-4 py-3"></div>
                        <div><label for="last_name" class="mb-2 block text-sm font-semibold">Last name</label><input id="last_name" type="text" name="last_name" value="{{ old('last_name') }}" placeholder="Last name" pattern="[A-Za-z ]+" title="Use letters and spaces only" class="field w-full rounded-md px-4 py-3" required></div>
                ...
                <section class="border-b border-[#d1d5db] p-6 md:p-8">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        ...
                        <div><label for="mobile_number" class="mb-2 block text-sm font-semibold">Mobile number</label><input id="mobile_number" type="tel" name="mobile_number" value="{{ old('mobile_number') }}" placeholder="09XXXXXXXXX" pattern="[0-9]{11}" maxlength="11" minlength="11" inputmode="numeric" title="Use exactly 11 digits" class="field w-full rounded-md px-4 py-3" required></div>
                ...
                <section class="p-6 md:p-8">
                    <div class="mb-6 flex items-start gap-4"><span class="section-number flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-sm font-bold">04</span><div><h2 class="text-xl font-bold">Upload profile picture</h2><p class="mt-1 text-sm text-slate-500">Please upload a recent, clear image in JPG or PNG format.</p></div></div>
